...
| BoxRFID OpenSpool Edition | V3.5 | Stable | Recommended OpenSpool-capable firmware | Yes | `firmware/boxrfid-openspool/v3.5/BoxRFID_CYD_ESP32_2432S028R_Qidi_OpenSpool_V3.5.ino.merged.bin` |

## Notes

- `V2.1` is the recommended public build for the classic QIDI workflow.
- `V3.5` is the recommended public build for users who need OpenSpool support.
